...
export const updateUserProfileSchema = z.object({
  ...
  housingType: z.enum(["rent_stabilized", "rent_controlled", "nycha", "private"]).optional(),
  knowsOrganizer: z.boolean().optional(),
  ...
  evictionCase: z.boolean().optional(),
  hasHpProceeding: z.boolean().optional(),
  registeredWithNonProfit: z.boolean().optional(),
  ...
  receivedCitySupport: z.boolean().optional(),
  ...
  receivedElectedSupport: z.boolean().optional(),
  ...
  atRiskHomelessness: z.boolean().optional(),
});
